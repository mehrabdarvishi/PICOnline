...
three_d_plot_switch_mode_btn.addEventListener('click', event => {
	...
	if (three_d_plot_mode == 'colored') {
		black_and_white_plot.style.display = 'flex';
		black_and_white_plot.style.justifyContent = "center";
		...
		colored_plot.style.display = 'flex';
		colored_plot.style.justifyContent = "center";
